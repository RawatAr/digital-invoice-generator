...
import { apiSendInvoiceEmail } from '@/lib/emailApi';
...
function InvoiceDetail() {
  ...
  const onSendEmail = async () => {
    ...
    setIsEmailBusy(true);
    try {
      const msg = await apiSendInvoiceEmail(token, invoice._id, money.currency);
      setNotice(typeof msg === 'string' ? msg : 'Email sent successfully');
    } catch (err) {
            ...
            <div className="grid gap-6 lg:grid-cols-5">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/30">
                  ...
                  <div className="divide-y divide-white/10">
                    {lineItems.length ? (
                      ...
                      <div className="p-5 text-sm text-white/60">No items attached.</div>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                  ...
                  <div className="mt-1 text-xs text-white/55">Status: {String(invoice.status || 'pending')}</div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
                  ...
                  <div className="mt-3 flex flex-col gap-2">
                    ...
                    >
                      {isEmailBusy ? 'Sending…' : 'Send email'}
                    </button>
