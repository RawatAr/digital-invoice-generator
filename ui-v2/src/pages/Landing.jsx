    ...
    <div className="relative">
      <div className="grid items-center gap-10 lg:grid-cols-2">
        ...
        <motion.section
          ...
          className="relative"
        >
          <div className="pointer-events-none absolute -inset-8 rounded-[2rem] bg-[radial-gradient(60%_50%_at_30%_0%,rgba(34,197,94,0.25),rgba(7,10,18,0))]" />
          <div className="ds-panel relative overflow-hidden p-7">
            <div className="absolute inset-x-0 top-0 h-24 bg-[linear-gradient(90deg,rgba(34,197,94,0.18),rgba(34,211,238,0.14),rgba(139,92,246,0.16))]" />
            <div className="relative">
